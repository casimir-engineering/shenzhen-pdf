...
13. First launch should feel instant, and tab hover titles must not stick.
   ...
   - Changed: Mac live zoom/unzoom now scales the previous high-quality viewport crop instead of falling back to the minimap thumbnail, and renders cheap 1x viewport crops during the gesture before the final quality render settles.
